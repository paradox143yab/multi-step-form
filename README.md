...
- Live Site URL: [https://paradox143yab.github.io/multi-step-form/]
...
---- i learned how to set any element in the center using these
display: flex;
justify-content: center;
align-items: center;

--- how to validate a form using javascript
--- How to use checkbox value to change the lists background color
